...
// Build the query to check for the user in the "farmer" table
$sql = "SELECT * FROM farmer WHERE username = '$username' AND password = '$password'"; // Modify if password is stored as plain text
...
if (mysqli_num_rows($result) > 0) {
    ...
    // You can start a session here to store user information
     header("Location: farmer_dashboard.html"); // Example redirect
} else {
